namespace BashSoft
{
    ...
    public static class CommandInterpreter
    {
        ...
        {
            var data = input.Split(new[] { ' ' }, System.StringSplitOptions.RemoveEmptyEntries);
        ...
        private static void TryChangeAbsolute(string input, string[] data)
        {
            if (data.Length == 2)
            {
